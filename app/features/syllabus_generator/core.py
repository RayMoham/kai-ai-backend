...
from app.features.syllabus_generator.tools import CourseType
...
def executor(grade: str, subject: str, course_type:CourseType) -> str:
    """
    ...
    """
    try:
        Generator = Syllabus_generator(grade,subject,course_type,API_KEY,SEARCH_ENGINE_ID,"app/features/syllabus_generator")
