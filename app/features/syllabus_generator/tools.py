...
class Syllabus_generator :
    ...
    def __init__(self,grade,subject,course_type,API_KEY,SEARCH_ENGINE_ID,path=""):
        self.grade = grade
        self.subject = subject
    ...
    def course_description(self) -> str:
        ...
        response = chain.invoke({"grade":self.grade,"subject":self.subject,"course_type":self.course_type})
        return response
